...
`--strictBindCallApply`                        | `boolean` | `false`                        | Enable stricter checking of the arguments of `Function.prototype.bind`, `Function.prototype.call`, and `Function.prototype.apply`.
