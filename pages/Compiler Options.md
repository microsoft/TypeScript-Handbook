...
`--project`                             | `-p`      | Compile the project in the given directory. The directory needs to contain a `tsconfig.json` file to direct compilation. See [tsconfig.json](./tsconfig.json.html) documentation for more details.
...
`--jsx`                                 |           |  Support JSX in '.tsx' files: 'React' or 'Preserve'. See [JSX](./jsx.html).
