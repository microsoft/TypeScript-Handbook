...
`this` | Type annotation | [Polymorphic `this` types in class/interface](Advanced%20Types#polymorphic-this-types)
...
`this is` _T_ | | [User-defined type guards](Advanced%20Types#user-defined-type-guards)
