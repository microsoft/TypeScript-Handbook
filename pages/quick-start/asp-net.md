...
5. Choose **MVC**
    ...
    ![Use MVC template](assets/asp/new-asp-project-template.png)
...
![src folder](assets/asp/src-folder.png)
...
1. In the **Solution Explorer**, open **Views** | **Home** | `Index.cshtml`.
   ...
   ![Open Index.cshtml](assets/asp/open-index.png)
...
2. Use PackageInstaller to install Angular 2, systemjs and Typings.
   ...
   ![Use PackageInstaller to install angular2](assets/asp/packageinstaller-angular2.png)
   ![Use PackageInstaller to install systemjs](assets/asp/packageinstaller-systemjs.png)
   ![Use PackageInstaller to install Typings](assets/asp/packageinstaller-typings.png)
...
3. Use PackageInstaller to install typings for es6-shim.
   ...
   ![Use PackageInstaller to install es6-shim typings](assets/asp/packageinstaller-es6-shim.png)
