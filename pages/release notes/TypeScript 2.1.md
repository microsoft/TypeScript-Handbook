...
## [`Partial`, `Readonly`, `Record`, and `Pick`](#partial-readonly-record-pick)
...
# [Support for external helpers library (`tslib`)](#support-for-external-helpers-library)
...
# [Support for `--target ES2016`, `--target ES2017` and `--target ESNext`](#support-for-target-es2016-es2017-esnext)
