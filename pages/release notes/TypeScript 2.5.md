...
# [Type assertion/cast syntax in `checkJs`/`@ts-check` mode](#type-assertion-cast-syntax-in-checkjs-tscheck-mode)
...
# [The `--preserveSymlinks` compiler flag](#preservesymlinks-compiler-flag)
