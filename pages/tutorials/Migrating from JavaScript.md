...
# [Setting up your Directories](#directories)
...
# [Writing a Configuration File](#config)
...
# [Moving to TypeScript Files](#moving-to-ts-files)
...
## [Weeding out Errors](#weeding-errors)
...
## [Getting Stricter Checks](#stricter-checks)
